...
# Opencv DNN
net = cv2.dnn.readNet("pythonProject4\dnn_model\yolov4-tiny.cfg", "pythonProject4\dnn_model\yolov4-tiny.weights")
model = cv2.dnn_DetectionModel(net)
model.setInputParams(size=(320, 320), scale=1/255)
# Load class Lists
classes = []
with open("pythonProject4\dnn_model\classes.txt", "r") as file_object:
